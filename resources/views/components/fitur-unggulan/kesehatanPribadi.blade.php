...
<div class="relative mb-8 flex items-center border border-green-400 rounded-lg p-4 bg-white w-[423px] h-[106px]">
  ...
  <div class="text-green-500 text-3xl mr-4">
    <img src="{{ asset('images/fitur-unggulan/kesehatanPribadi.png') }}" alt="">
  </div>
  ...
  <div>
    ...
    <p class="text-gray-600 text-sm">
      Pantau kondisi tubuh seperti tekanan darah, detak jantung, gula darah,
      dan lainnya secara berkala.
    </p>
  </div>
