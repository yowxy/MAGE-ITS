...
<body>
    ...
    <div class="w-1/2 h-full flex justify-center items-center">
        <div class="w-[500px]">
            ...
            <p class="text-gray-500 mb-8">Akses akun Anda untuk memantau kesehatan <br> dan mendapatkan rekomendasi terbaik setiap hari.</p>
            ...
            <p class="text-gray-500 text-[13px]">Belum punya akun? <a href="/register" class="text-green-500">Daftar</a></p>
        </div>
    </div>
